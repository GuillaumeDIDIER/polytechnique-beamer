...
{
\setbeamertemplate{background canvas}{\tikz[remember picture,overlay]\node[shift={(-1.25cm,1.25cm)},opacity=0.8] at (current page.south east) {\includegraphics[width=8cm,keepaspectratio]{./img/escher1}};}
